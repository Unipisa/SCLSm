...
namespace SCLS.Splasher
{
    ...
    public class SplashForm : Form
    {
        ...
        public SplashForm(int image, Color col)
        {
            ...
            //this.TransparencyKey = m_transColor;
            ...
            //TODO : Load bmp from resources
            // load and make the bitmap transparent
            System.Reflection.Assembly thisExe;
            thisExe = System.Reflection.Assembly.GetExecutingAssembly();
            //WindowsApplication9.Resources.taxxassplash.jpg

            //System.IO.Stream file = thisExe.GetManifestResourceStream("SplashScreen.Properties.Resources.root_splash3"); // String to be changed to your environment!
            //m_bmp = new Bitmap(file); 
            
            // load and make the bitmap transparent
            //m_bmp = new Bitmap(imageFile);
            //Bitmap m_bmp = (Bitmap)null;//SplashScreen.Properties.Resources.root_splash3;

            if (image == 0)
            {
                m_bmp = SplashScreen.Properties.Resources.root_splash3;
            }
            else 
            {
                m_bmp = SplashScreen.Properties.Resources.wait;
            }
        ...
        public static void ShowModal(int in_image, Color col)
        {
        ...
        public static void StartSplash(int in_image, Color col)
        {
            //m_imageFile = imageFile;
            image = in_image;
            m_transColor = col;
        ...
        {
            m_instance = new SplashForm(image, m_transColor);
